...
* Having run the Heckman two-step estimation procedure and calculated the marginal effect of income on credi card spending we see that a 10% increase in income is estimated to increase credit card spending by `r marginal.effect.income*10`%.
