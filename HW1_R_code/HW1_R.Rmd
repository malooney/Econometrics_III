...
reps <- 1e2 # number of ols iterations
i <- 1 # counter
temp <- matrix(nrow = reps, ncol = 5) # matrix to stuff results into dim= "reps" X 3
x1 <- data$X2
x2 <- data$X3
...
reps <- 1e2 # number of ols iterations
i <- 1 # counter
temp <- matrix(nrow = reps, ncol = 13) # matrix to stuff results into dim= "reps" X 3
x1 <- data$X2
x2 <- data$X3
...
# temp[i,1] <- rho_hat_fgls
# temp[i,2] <- sigma2_hat_fgls
# temp[i,3] <- b_ols_fgls[1]
# temp[i,4] <- b_ols_fgls[2]
# temp[i,5] <- b_ols_fgls[3]
