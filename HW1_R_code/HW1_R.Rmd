...
**This is a modified version of the Breusch-Pagan test, which is less sensitive to the assumption of normality than the original test (Greene 1993, 7th Ed.; p. 395).**
...
```{r MLE section, echo=FALSE, message=FALSE, results='asis', fig.height=3}
...
reps <- 1e2 # number of ols iterations
i <- 1 # counter
temp <- matrix(nrow = reps, ncol = 10) # matrix to stuff results into dim= "reps" X 3
x1 <- data$X2
x2 <- data$X3
...
dimnames(temp) <- list(c(), c("beta_0_mle", "beta_1_mle", "beta_2_mle", "alpha_0_mle", "alpha_1_mle", "var_b0_mle", "var_b1_mle", "var_b2_mle", "var_alpha_0_mle", "var_alpha_1_mle"))
```
