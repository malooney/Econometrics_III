...
reps <- 1e2 # number of ols iterations
i <- 1 # counter
temp <- matrix(nrow = reps, ncol = 21) # matrix to stuff results into dim= "reps" X 3
x1 <- data$X2
x2 <- data$X3
...
lnL= (-0.5* log(2* pi)- 0.5* log(sigma^2)+ 0.5* log(1- rho^2)- ( ( (1- rho^2)* (y[1]- (beta1+ beta2* x1[1]+ beta3* x2[1]) )^2 ) / (2*sigma^2) ) ) + sum( -0.5* log(2* pi)- 0.5* log(sigma^2) - ( ( (y_t - rho* y_t_1)- (beta1*(1-rho)+ beta2*(x1_t- rho*x1_t_1)+ beta3*(x2_t- rho*x2_t_1)) )^2  / (2* sigma^2) ) )
...
dimnames(temp) <- list(c(), c("beta_0_mle", "beta_1_mle", "beta_2_mle", "rho_mle", "sigma_mle", "var_b0_mle", "var_b1_mle", "var_b2_mle", "var_rho_mle", "var_sigma_mle", "se_b0_mle", "se_b1_mle", "se_b2_mle", "se_rho_mle", "se_sigma_mle", "t_val_b0_mle", "t_val_b1_mle", "t_val_b2_mle", "t_val_rho_mle", "t_val_sigma_mle", "lnL_value"))
