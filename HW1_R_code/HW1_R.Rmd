...
stargazer(temp, header=F, type="latex", summary = T, font.size = "small", notes= c("BP testStat ols = Breusch Pagan test against heteroskedasticity", "GV HET Test ols = General test for LM assumptions", "Chi Squared Critical value for two degrees of freedom at 95% level = 5.99"), notes.align= "l", flip = F, float = T, float.env = "table", title="Summary Statistics", median = F)
